...
AlliedSingleField::AlliedSingleField(QWidget *parent) : AbstractSingleField(parent)
{
...
void AlliedSingleField::update(const QVector<QVector<Field::FieldPlace> > &field)
{
    this->field = field;
    this->repaint();
}

void AlliedSingleField::drawField(QPainter *qp)
{
