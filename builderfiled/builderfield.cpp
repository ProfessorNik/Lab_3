...
BuilderField::BuilderField(QWidget *parent) : QWidget(parent)
{
    ...
    connect(ship1, &ShipWidget::shipSelected, this, &BuilderField::shipSelected);
    connect(ship2, &ShipWidget::shipSelected, this, &BuilderField::shipSelected);
    connect(ship3, &ShipWidget::shipSelected, this, &BuilderField::shipSelected);
    connect(ship4, &ShipWidget::shipSelected, this, &BuilderField::shipSelected);

    QVBoxLayout* singleFieldLayout = new QVBoxLayout;
    field = new BuilderFieldWidget;
    singleFieldLayout->addWidget(field);

    connect(field, &BuilderFieldWidget::mouseOnPosition, this, &BuilderField::showShip);
    connect(field, &BuilderFieldWidget::mouseOut, this, &BuilderField::hideShip);
    connect(field, &BuilderFieldWidget::putShipTo, this, &BuilderField::putShipTo);
    connect(field, &BuilderFieldWidget::rotateShip, this, &BuilderField::rotateShip);
