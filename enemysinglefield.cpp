...
EnemySingleField::EnemySingleField(QWidget *parent) : AbstractSingleField(parent)
{
...
void EnemySingleField::update(const QVector<QVector<Field::FieldPlace> > &field)
{
    this->field = field;
    this->repaint();
}

void EnemySingleField::drawField(QPainter *qp)
{
